...
1. From your local environment, set the hex private key of your funded deployer address to `HYP_KEY`. For example: `export HYP_KEY='<YOUR_PRIVATE_KEY>'` (64 hex chars, no `0x` prefix)
