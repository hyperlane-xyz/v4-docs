...
1. From your local environment, set the hex private key of your funded deployer address to `HYP_KEY`. For example: `export HYP_KEY='33913dd43a5d5764f7a23da212a8664fc4f5eedc68db35f3eb4a5c4f046b5b51'`
