...
The `interchainGasPaymaster` value is the overhead IGP address from your SVM chain's core deployment artifacts at `rust/sealevel/environments/mainnet3/<chain>/core/program-ids.json`.
