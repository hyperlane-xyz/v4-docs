...
ethereum:
  ...
  interchainSecurityModule: "0x0000000000000000000000000000000000000000" # Use destination Mailbox default ISM
...
```bash
hyperlane warp send --origin ethereum --destination yourcosmoschain --warpRouteId USDC/ethereum --relay
```
