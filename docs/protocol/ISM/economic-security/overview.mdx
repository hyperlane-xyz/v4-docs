...
Staking and slashing allow economic security to be added to ISMs that rely on validator signatures, including [Multisig ISM](/docs/protocol/ISM/standard-ISMs/multisig-ISM.mdx) and Optimistic ISM.
