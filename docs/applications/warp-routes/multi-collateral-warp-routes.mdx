...
A Hyperlane Warp Routes 2.0, on the other hand, allows users to bridge from multiple collateral chains.
...
- To deploy Hyperlane Warp Routes 2.0 head over to [Deploy a Hyperlane Warp Routes 2.0](/docs/guides/warp-routes/evm/deploy-multi-collateral-warp-routes)
