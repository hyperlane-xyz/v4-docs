...
- **Chains**: Arbitrum, Avalanche, Base, Ethereum, HyperEVM, Ink, Linea, OP Mainnet, Plume, Polygon PoS, Sei, Sonic, Unichain and World Chain
  - Support for additional chains which are supported by [Circle CCTP](https://developers.circle.com/cctp) v1/v2 and Everclear will roll out incrementally.

### ETH

- Support for chains supported by Everclear will roll out incrementally.
...
<Note>
  ...
  rebalancing](/docs/guides/warp-routes/evm/multi-collateral-warp-routes-rebalancing#requirements-for-native-rebalancing)
</Note>
