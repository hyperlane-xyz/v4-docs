...
<Note>
  Validators will only earn rewards if they are selected to be a part of
  Hyperlane's default ISMs.
</Note>
...
1. Opt-in to the Hyperlane Network on Symbiotic:
...
2. Opt-in to the HYPER vault on Symbiotic:
...
UserReward=(∑i=1N​Useri​’s WeightUser’s Weight​)×R
