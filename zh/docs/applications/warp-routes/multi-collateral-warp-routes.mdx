...
要了解更多关于原生重新平衡的信息，请前往：[HWR 2.0：原生重新平衡](/zh/docs/guides/warp-routes/evm/multi-collateral-warp-routes-rebalancing)
...
<Note>
原生重新平衡的链支持取决于协议可用性和代币桥接基础设施。阅读更多关于[原生重新平衡要求](/zh/docs/guides/warp-routes/evm/multi-collateral-warp-routes-rebalancing#requirements-for-native-rebalancing)的信息
</Note>

## 指南

- 要部署 Hyperlane Warp 路由 2.0，请前往[部署 Hyperlane Warp 路由 2.0](/zh/docs/guides/warp-routes/evm/deploy-multi-collateral-warp-routes)