...
1. [`Mailbox`](/zh/docs/protocol/core/mailbox)（必需）
2. [`IPostDispatchHook`](/zh/docs/protocol/core/post-dispatch-hooks-overview)（可选）
3. [`IInterchainSecurityModule`](/zh/docs/protocol/ISM/modular-security)（可选）
