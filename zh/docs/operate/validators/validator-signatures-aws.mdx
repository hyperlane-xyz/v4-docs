...
如果您只是想为测试或开发目的运行 Validator，请考虑遵循[本地设置指南](/zh/docs/guides/chains/deploy-hyperlane-with-local-agents)。
...
<Tip>
  高级用户可以考虑使用 [S3 Terraform 模块](/zh/docs/operate/guides/deploy-with-terraform#modules)来创建具有正确权限的 S3 存储桶。
</Tip>